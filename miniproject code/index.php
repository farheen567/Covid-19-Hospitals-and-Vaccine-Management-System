...
$r1=mysqli_query($con,"select * from block1;");
$r2=mysqli_query($con,$q2);
$start=date('Y-m-d H:i:s');
while($row=mysqli_fetch_array($r2))
{
$t=date('Y-m-d H:i:s',strtotime('+48 hour',strtotime($row["time"])));
if($start>=$t)
{
	$h=$row["hpid"];
	$q8= mysqli_query($con,"delete from hospitals where hpid='$h';");
	$q6=mysqli_query($con,"delete from appointment where hpid='$h';");		
}
}
...
{
	$h=$row["vid"];
	$q8= mysqli_query($con,"delete from vcenters where vid='$h';");	
}
}
?>
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp HEALTH SERVICE</h4></a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 register-right" style="margin-top: 40px;left: 80px;">
                        <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist" style="width: 40%;">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#admin" role="tab" aria-controls="admin" aria-selected="false">Super Admin</a>
                            </li>
                        </ul>
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="email" class="form-control" placeholder="Your Email *" id="email" name="email" onfocusout='validateEmail();' required/>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control"  id="cpassword" placeholder="Confirm Password *" name="cpassword"  onkeyup='return check();' required/><span id='message'></span>
                                        </div>
